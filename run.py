...
""")
	...
	[table, operation, colume, groupcolume, sql, window, slide, duration, where] = arguments
	...
	spark_submit_args = "'%s' '%s' '%s' '%s' '%s' '%s' '%s' '%s' '%s' '%s' '%s'" %(table, operation, colume, groupcolume, sql, window, slide, duration, topic, name, where)
